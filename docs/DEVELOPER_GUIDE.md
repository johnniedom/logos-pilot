...
```bash
# Unit tests (216 tests, no runtime needed)
...
|-------|-----------|-------------|
| Unit tests (`nix build .#unit-tests`) | All 216 tests: crypto, skills, LLM, spending FSM, A2A, storage config | No inter-module calls |
