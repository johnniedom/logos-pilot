...
| Paid skill marketplace | 2026-09-09, run 34337961562 (on the chain as reset on 2026-09-08): A funded its private account with a real proof (`GYj3…` 150 → 50), discovered B's card on the discovery topic, bought `agent.ask`, and its settlement paid B's declared 5 LEZ over the private rail with a second real proof, tx `8f1ad51a…` in block 1355 (A private 100 → 95); 128 min. First passed 2026-09-05 as run 33982458566, before the reset |
